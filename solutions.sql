...
-- 1. Find all subjects sorted by subject
    SELECT * FROM subjects -- (for this table, the default is by subject, but you could add ORDER BY subject to the query if you like to type extra things for fun or something.)
