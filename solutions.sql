-- ### Order
 ...
 -- 	* ship date
 -- 	* book title
    SELECT books.title, customers.first_name, customers.last_name, shipments.ship_date FROM shipments
    ...
    ORDER BY shipments.ship_date;q
 ...
 -- 12. Get the COUNT of all Location
 ...
 -- 14. List all books. Display the book_id, title, and a count of how many editions each book has. (hint: requires GROUP BY and JOIN)
    SELECT editions.book_id, books.title, COUNT(editions.edition) FROM books JOIN editions ON editions.book_id = books.id GROUP BY editions.book_id, books.title;